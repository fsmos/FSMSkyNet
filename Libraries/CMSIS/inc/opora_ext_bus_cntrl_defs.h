...
#define EXT_BUS_CNTRL_RAM_CYCLES_ENABLE_TUNE_OFFS	0
#define EXT_BUS_CNTRL_RAM_CYCLES_ENABLE_TUNE		((uint32_t)0x00000001)

#define EXT_BUS_CNTRL_RAM_CYCLES_WS_ACTIVE_OFFS		1
#define EXT_BUS_CNTRL_RAM_CYCLES_WS_ACTIVE_Msk		((uint32_t)0x000000FE)

#define EXT_BUS_CNTRL_RAM_CYCLES_WS_SETUP_OFFS		8
#define EXT_BUS_CNTRL_RAM_CYCLES_WS_SETUP_Msk		((uint32_t)0x00000700)

#define EXT_BUS_CNTRL_RAM_CYCLES_WS_HOLD_OFFS		11
#define EXT_BUS_CNTRL_RAM_CYCLES_WS_HOLD_Msk		((uint32_t)0x00003800)
